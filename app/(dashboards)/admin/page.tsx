      ...
      <div className="p-6">
        ...
        <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
          <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-4">
            ...
            <p className="mt-2 text-3xl font-bold text-white">{kpis.users.total}</p>
          ...
          <div className="rounded-xl border border-blue-500/30 bg-blue-500/5 p-4">
            ...
            <p className="mt-2 text-3xl font-bold text-white">{kpis.startups.total}</p>
            <p className="mt-1 text-xs text-slate-500">
          ...
          <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-4">
            ...
            <p className="mt-2 text-3xl font-bold text-white">{kpis.innovation_score_avg}</p>
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-pink-500/30 bg-pink-500/5 p-4">
            ...
            <p className="mt-2 text-2xl font-bold text-white">{kpis.engagement.active_matches}</p>
          </div>
          <div className="rounded-xl border border-teal-500/30 bg-teal-500/5 p-4">
            ...
            <p className="mt-2 text-2xl font-bold text-white">{kpis.engagement.active_mentorships}</p>
          </div>
          <div className="rounded-xl border border-blue-500/30 bg-blue-500/5 p-4">
            <p className="text-xs text-slate-400">Activity (24h)</p>
            <p className="mt-2 text-2xl font-bold text-white">{kpis.engagement.activity_24h}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-400">Charts and visualizations</p>
          </a>
          <a
            href="/admin/insights"
            className="rounded-xl border border-white/10 bg-white/5 p-4 transition hover:border-purple-500/30"
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-400">Real-time platform logs</p>
          </a>
        </div>
      </div>
    </div>
