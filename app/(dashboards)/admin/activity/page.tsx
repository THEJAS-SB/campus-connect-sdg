        ...
        {activities.length === 0 ? (
          <div className="flex min-h-[400px] items-center justify-center rounded-xl border border-dashed border-white/20">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">Platform activity will appear here</p>
            </div>
          </div>
        ) : (
          <div className="space-y-2">
            {activities.map((activity) => {
              ...
              const color = ACTIVITY_COLORS[activityType] ?? 'border-white/10 bg-white/5'
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <p className="mt-0.5 text-xs text-slate-400">
                            ...
                            {profile?.rs_id && (
                              <span className="ml-2 text-slate-500">RS: {profile.rs_id}</span>
                            )}
                          </p>
                        </div>
